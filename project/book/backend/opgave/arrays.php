...
<head><title>Arrays</title></head>
    ...
    echo "<br>---- Opgave 19: Tekst1 in array1 conventeren:";
    $array1 = explode("*",$tekst1);
    array_walk($array1, 'printArray');

    echo "<br>---- Opgave 19: Tekst2 in array2 conventeren:";
    ...
    $boeken = array(
        ...
        array("titel"=> "De cirkel","autor"=> "Dave Eggers",
