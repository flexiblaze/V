...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>Corleone Calzone</span> Pizza</a>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>6026836@mborijnland.nl</p>
      </div>

   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>Soroosh en Ömer</span> | All rights reserved!
   </div>
